...
- Unit тесты для компонентов и store
- E2E тесты
...
- При перезагрузке страницы изменения сбрасываются
- Timestamps в JSON файле указаны в секундах Unix времени
- Автоимпорты Nuxt 3 используются для упрощения импортов

## 🤝 Вклад в проект

При разработке следуйте принципам:

- Использование TypeScript для всех новых компонентов
- Composition API вместо Options API
- Строгое разделение ответственности компонентов
- Покрытие тестами критичной функциональности
